...
function ReceiverMessage({message}) {
  ...
  return (
    <div ref={scroll} className='w-fit max-w-[60%] bg-[#1a1f1f] rounded-t-2xl
    rounded-br-2xl rounded-bl-0 px-[10px] py-[10px] relative left-0 flex flex-col gap-[10px]'>
      ...
      <div className='w-[30px] h-[30px] rounded-full cursor-pointer overflow-hidden absolute
